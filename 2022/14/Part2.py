...
class Grid:
    ...
    def sand(self) -> int:
        ...
        # Add floor
        self.addRock([[500 - 2*(500 - min_x + max_y_rock), max_y_rock + 2], [500 + 2*(max_x - 500 + max_y_rock), max_y_rock + 2]])
        max_y_rock += 2
        ...
        while change:
            ...
            # already sand at start
            if self.getEntry(sand_x, sand_y) == Point.SAND:
                break
